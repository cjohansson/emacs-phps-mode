...
EL  := phps-mode-flymake.el phps-mode-font-lock.el phps-mode-functions.el phps-mode-map.el phps-mode-semantic.el phps-mode-syntax-table.el phps-mode-test-functions.el phps-mode-test-lexer.el phps-mode-test-parser.el phps-mode.el
ELC := $(EL:.el=.elc)
