  ...
  (should
   (equal
    (phps-mode-parser-custom--parse
     (list '(T_SWITCH 7 . 13) '("(" 14 . 15) '(T_STRING 15 . 32) '("(" 32 . 33) '(")" 33 . 34) '(")" 34 . 35) '("{" 36 . 37) '(T_CASE 38 . 42) '(T_CONSTANT_ENCAPSED_STRING 43 . 59) '(":" 59 . 60) '(T_ECHO 61 . 65) '(T_CONSTANT_ENCAPSED_STRING 66 . 87) '(";" 87 . 88) '("}" 89 . 90)))
    t))
