...
(defun phps-mode-test-ast-bookkeeping ()
  ...
  (phps-mode-test-ast--should-bookkeep
   ...
   '(("namespace myNamespaceA id $var" . 37) ("namespace myNamespaceAclass myClassAfunction myFunctionB id $var5" . 485) ("namespace myNamespaceAclass myClassAfunction myFunctionB id $this" . 500) ("namespace myNamespaceAclass myClassAfunction myFunctionB id $var6" . 514) ("namespace myNamespaceAclass myClassAfunction myFunctionA id $var3" . 142) ("namespace myNamespaceAclass myClassAfunction myFunctionA id $var4" . 163) ("namespace myNamespaceAclass myClassA id $var2" . 86) ("namespace myNamespaceB id $var7" . 1243) ("namespace myNamespaceBclass myClassBfunction myFunctionB id $var12" . 2088) ("namespace myNamespaceBclass myClassBfunction myFunctionB id $this" . 2104) ("namespace myNamespaceBclass myClassBfunction myFunctionB id $var11" . 2118) ("namespace myNamespaceBclass myClassBfunction myFunctionA id $var10" . 1335) ("namespace myNamespaceBclass myClassBfunction myFunctionA id $this" . 1343) ("namespace myNamespaceBclass myClassBfunction myFunctionA id $var9" . 1357) ("namespace myNamespaceBclass myClassB id $var8" . 1293)))
