...
(defun phps-mode-test-lex-analyzer--bookkeeping ()
  ...
  (phps-mode-test--with-buffer
   ...
   (should (equal
            ...
            (list (list "$_COOKIE" t) (list "$_GET" t) (list "$_GLOBALS" t) (list "$_POST" t) (list "$_REQUEST" t) (list "$_SERVER" t) (list "$_SESSION" t) (list " id $var" 1) (list (list 8 12) t) (list (list 27 32) nil) (list (list 73 77) t)))))
  ...
  (phps-mode-test--with-buffer
   ...
   (should (equal
            (phps-mode-test--hash-to-list (phps-mode-lex-analyzer--get-bookkeeping) t)
            (list (list "$_COOKIE" t) (list "$_GET" t) (list "$_GLOBALS" t) (list "$_POST" t) (list "$_REQUEST" t) (list "$_SERVER" t) (list "$_SESSION" t) (list " id $var" 1) (list (list 8 12) t) (list (list 27 31) t) (list (list 72 77) nil)))))
  ...
  (phps-mode-test--with-buffer
   ...
   (should (equal
            (phps-mode-test--hash-to-list (phps-mode-lex-analyzer--get-bookkeeping) t)
            (list (list "$_COOKIE" t) (list "$_GET" t) (list "$_GLOBALS" t) (list "$_POST" t) (list "$_REQUEST" t) (list "$_SERVER" t) (list "$_SESSION" t) (list " id $var" 1) (list (list 37 41) t) (list " namespace myNamespaceA class myClassA id $var2" 1) (list (list 86 91) t) (list " namespace myNamespaceA class myClassA function myFunctionA id $this" t) (list " namespace myNamespaceA class myClassA function myFunctionA id $var3" 1) (list (list 128 133) t) (list " namespace myNamespaceA class myClassA function myFunctionA id $var4" 1) (list (list 149 154) t) (list (list 178 182) nil) (list (list 245 250) nil) (list (list 313 318) t) (list (list 380 385) t) (list " namespace myNamespaceA class myClassA function myFunctionB id $this" t) (list " namespace myNamespaceA class myClassA function myFunctionB id $var5" 1) (list (list 471 476) t) (list " namespace myNamespaceA class myClassA function myFunctionB id $var6" 1) (list (list 500 505) t) (list (list 529 533) nil) (list (list 596 601) nil) (list (list 664 669) nil) (list (list 732 737) nil) (list (list 800 805) t) (list (list 867 872) t) (list (list 943 947) t) (list (list 985 990) nil) (list (list 1029 1034) nil) (list (list 1073 1078) nil) (list (list 1117 1122) nil) (list (list 1161 1166) nil) (list " id $var7" 1) (list (list 1229 1234) t) (list " namespace myNamespaceB class myClassB id $var8" 1) (list (list 1279 1284) t) (list " namespace myNamespaceB class myClassB function myFunctionA id $this" t) (list " namespace myNamespaceB class myClassB function myFunctionA id $var10" 1) (list (list 1321 1327) t) (list " namespace myNamespaceB class myClassB function myFunctionA id $var9" 1) (list (list 1343 1348) t) (list (list 1372 1376) nil) (list (list 1439 1444) nil) (list (list 1507 1512) nil) (list (list 1575 1580) nil) (list (list 1643 1648) nil) (list (list 1711 1716) nil) (list (list 1779 1784) nil) (list (list 1847 1852) nil) (list (list 1915 1920) t) (list (list 1982 1988) t) (list " namespace myNamespaceB class myClassB function myFunctionB id $this" t) (list " namespace myNamespaceB class myClassB function myFunctionB id $var12" 1) (list (list 2074 2080) t) (list " namespace myNamespaceB class myClassB function myFunctionB id $var11" 1) (list (list 2104 2110) t) (list (list 2134 2138) nil) (list (list 2201 2206) nil) (list (list 2269 2274) nil) (list (list 2337 2342) nil) (list (list 2405 2410) nil) (list (list 2472 2477) nil) (list (list 2539 2544) nil) (list (list 2607 2612) nil) (list (list 2675 2680) nil) (list (list 2743 2749) nil) (list (list 2812 2818) t) (list (list 2880 2886) t) (list (list 2957 2961) t) (list (list 2999 3004) nil) (list (list 3043 3048) nil) (list (list 3087 3092) nil) (list (list 3131 3136) nil) (list (list 3175 3180) nil) (list (list 3219 3224) t)))))
