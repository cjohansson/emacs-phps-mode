...
(defun phps-mode-test-lex-analyzer--bookkeeping ()
  ...
  (phps-mode-test--with-buffer
   ...
   (should (equal
            ...
            (list (list " id $var" 1) (list (list 8 12) t) (list (list 27 32) nil) (list (list 73 77) t)))))
  ...
  (phps-mode-test--with-buffer
   ...
   (should (equal
            (phps-mode-test--hash-to-list (phps-mode-lex-analyzer--get-bookkeeping) t)
            (list (list " id $var" 1) (list (list 8 12) t) (list (list 27 31) t) (list (list 72 77) nil)))))
  ...
  (phps-mode-test--with-buffer
   ...
   (should (equal
            (phps-mode-test--hash-to-list (phps-mode-lex-analyzer--get-bookkeeping) t)
            (list (list (list 30 35) t) (list (list 61 67) t) (list (list 93 101) t) (list (list 127 136) t) (list (list 162 171) t) (list (list 197 206) t) (list (list 232 240) t) (list (list 266 273) t)))))
  ...
  (phps-mode-test--with-buffer
   ...
   (should (equal
            (phps-mode-test--hash-to-list (phps-mode-lex-analyzer--get-bookkeeping) t)
            (list (list " id $e" 1) (list (list 38 40) t) (list (list 52 54) t) (list (list 91 93) t)))))
