...
(defun phps-mode-test-lex-analyzer--bookkeeping ()
  ...
  (phps-mode-test--with-buffer
   ...
   (should
    (equal
     (phps-mode-test--hash-to-list (phps-mode-lex-analyzer--get-bookkeeping) t)
     (list (list (list 30 35) 1) (list (list 61 67) 1) (list (list 93 101) 1) (list (list 127 136) 1) (list (list 162 171) 1) (list (list 197 205) 1) (list (list 231 239) 1) (list (list 265 272) 1) (list (list 298 303) 1)))))
