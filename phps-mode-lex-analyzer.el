...
(defun phps-mode-lex-analyzer--get-token-syntax-color (token)
  ...
  (let ((start (car (cdr token)))
    ...
    (cond
     ...
     ((and
       (string= token-name 'T_VARIABLE)
       phps-mode-lex-analyzer--processed-buffer-p)
      (if (gethash (list (1- start) (1- end)) phps-mode-lex-analyzer--bookkeeping)
          (list 'font-lock-face 'font-lock-variable-name-face)
        (list 'font-lock-face 'font-lock-warning-face)))

     ((or
       (string= token-name 'T_VARIABLE)
       (string= token-name 'T_STRING_VARNAME))
      (list 'font-lock-face 'font-lock-variable-name-face))

     ((string= token-name 'T_COMMENT)
      (list 'font-lock-face 'font-lock-comment-face))

     ((string= token-name 'T_DOC_COMMENT)
      (list 'font-lock-face 'font-lock-doc-face))

     ((string= token-name 'T_INLINE_HTML)
      ;; NOTE T_INLINE_HTML is missing by purpose here to distinguish those areas from other entities
      nil)

     ((or
       (string= token-name 'T_STRING)
       (string= token-name 'T_CONSTANT_ENCAPSED_STRING)
       (string= token-name 'T_ENCAPSED_AND_WHITESPACE)
       (string= token-name 'T_NUM_STRING)
       (string= token-name 'T_DNUMBER)
       (string= token-name 'T_LNUMBER))
      (list 'font-lock-face 'font-lock-string-face))

     ((or
       (string= token-name 'T_DOLLAR_OPEN_CURLY_BRACES)
       (string= token-name 'T_CURLY_OPEN)
       (string= token-name 'T_OBJECT_OPERATOR)
       (string= token-name 'T_PAAMAYIM_NEKUDOTAYIM)
       (string= token-name 'T_NS_SEPARATOR)
       (string= token-name 'T_EXIT)
       (string= token-name 'T_DIE)
       (string= token-name 'T_RETURN)
       (string= token-name 'T_YIELD_FROM)
       (string= token-name 'T_YIELD)
       (string= token-name 'T_TRY)
       (string= token-name 'T_CATCH)
       (string= token-name 'T_FINALLY)
       (string= token-name 'T_THROW)
       (string= token-name 'T_IF)
       (string= token-name 'T_ELSEIF)
       (string= token-name 'T_ENDIF)
       (string= token-name 'T_ELSE)
       (string= token-name 'T_WHILE)
       (string= token-name 'T_ENDWHILE)
       (string= token-name 'T_DO)
       (string= token-name 'T_FUNCTION)
       (string= token-name 'T_FN)
       (string= token-name 'T_CONST)
       (string= token-name 'T_FOREACH)
       (string= token-name 'T_ENDFOREACH)
       (string= token-name 'T_FOR)
       (string= token-name 'T_ENDFOR)
       (string= token-name 'T_DECLARE)
       (string= token-name 'T_ENDDECLARE)
       (string= token-name 'T_INSTANCEOF)
       (string= token-name 'T_AS)
       (string= token-name 'T_SWITCH)
       (string= token-name 'T_ENDSWITCH)
       (string= token-name 'T_CASE)
       (string= token-name 'T_DEFAULT)
       (string= token-name 'T_BREAK)
       (string= token-name 'T_CONTINUE)
       (string= token-name 'T_GOTO)
       (string= token-name 'T_ECHO)
       (string= token-name 'T_PRINT)
       (string= token-name 'T_CLASS)
       (string= token-name 'T_INTERFACE)
       (string= token-name 'T_TRAIT)
       (string= token-name 'T_EXTENDS)
       (string= token-name 'T_IMPLEMENTS)
       (string= token-name 'T_NEW)
       (string= token-name 'T_CLONE)
       (string= token-name 'T_VAR)
       (string= token-name 'T_EVAL)
       (string= token-name 'T_INCLUDE_ONCE)
       (string= token-name 'T_INCLUDE)
       (string= token-name 'T_REQUIRE_ONCE)
       (string= token-name 'T_REQUIRE)
       (string= token-name 'T_NAMESPACE)
       (string= token-name 'T_USE)
       (string= token-name 'T_INSTEADOF)
       (string= token-name 'T_GLOBAL)
       (string= token-name 'T_ISSET)
       (string= token-name 'T_EMPTY)
       (string= token-name 'T_HALT_COMPILER)
       (string= token-name 'T_STATIC)
       (string= token-name 'T_ABSTRACT)
       (string= token-name 'T_FINAL)
       (string= token-name 'T_PRIVATE)
       (string= token-name 'T_PROTECTED)
       (string= token-name 'T_PUBLIC)
       (string= token-name 'T_UNSET)
       (string= token-name 'T_LIST)
       (string= token-name 'T_ARRAY)
       (string= token-name 'T_CALLABLE)
       )
      (list 'font-lock-face 'font-lock-keyword-face))

     ((or
       (string= token-name 'T_OPEN_TAG)
       (string= token-name 'T_OPEN_TAG_WITH_ECHO)
       (string= token-name 'T_CLOSE_TAG)
       (string= token-name 'T_START_HEREDOC)
       (string= token-name 'T_END_HEREDOC)
       (string= token-name 'T_ELLIPSIS)
       (string= token-name 'T_COALESCE)
       (string= token-name 'T_DOUBLE_ARROW)
       (string= token-name 'T_INC)
       (string= token-name 'T_DEC)
       (string= token-name 'T_IS_IDENTICAL)
       (string= token-name 'T_IS_NOT_IDENTICAL)
       (string= token-name 'T_IS_EQUAL)
       (string= token-name 'T_IS_NOT_EQUAL)
       (string= token-name 'T_SPACESHIP)
       (string= token-name 'T_IS_SMALLER_OR_EQUAL)
       (string= token-name 'T_IS_GREATER_OR_EQUAL)
       (string= token-name 'T_PLUS_EQUAL)
       (string= token-name 'T_MINUS_EQUAL)
       (string= token-name 'T_MUL_EQUAL)
       (string= token-name 'T_POW_EQUAL)
       (string= token-name 'T_POW)
       (string= token-name 'T_DIV_EQUAL)
       (string= token-name 'T_CONCAT_EQUAL)
       (string= token-name 'T_MOD_EQUAL)
       (string= token-name 'T_SL_EQUAL)
       (string= token-name 'T_SR_EQUAL)
       (string= token-name 'T_AND_EQUAL)
       (string= token-name 'T_OR_EQUAL)
       (string= token-name 'T_XOR_EQUAL)
       (string= token-name 'T_COALESCE_EQUAL)
       (string= token-name 'T_BOOLEAN_OR)
       (string= token-name 'T_BOOLEAN_AND)
       (string= token-name 'T_BOOLEAN_XOR)
       (string= token-name 'T_LOGICAL_XOR)
       (string= token-name 'T_LOGICAL_OR)
       (string= token-name 'T_LOGICAL_AND)
       (string= token-name 'T_SL)
       (string= token-name 'T_SR)
       (string= token-name 'T_CLASS_C)
       (string= token-name 'T_TRAIT_C)
       (string= token-name 'T_FUNC_C)
       (string= token-name 'T_METHOD_C)
       (string= token-name 'T_LINE)
       (string= token-name 'T_FILE)
       (string= token-name 'T_DIR)
       (string= token-name 'T_NS_C)
       (string= token-name 'T_INT_CAST)
       (string= token-name 'T_DOUBLE_CAST)
       (string= token-name 'T_STRING_CAST)
       (string= token-name 'T_ARRAY_CAST)
       (string= token-name 'T_OBJECT_CAST)
       (string= token-name 'T_BOOL_CAST)
       (string= token-name 'T_UNSET_CAST)
       )
      (list 'font-lock-face 'font-lock-constant-face))

     ((string= token-name 'T_ERROR)
