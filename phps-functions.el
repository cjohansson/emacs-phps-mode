            ...
            (let ((token (car item))
              ...
              (when (<= token-end line-beginning)
                ...
                (pcase token
                  ...
                  ('T_CURLY_OPEN (setq start-brace-level (+ start-brace-level 1)))
                  ('T_DOLLAR_OPEN_CURLY_BRACES (setq start-brace-level (+ start-brace-level 1)))
              ...
              (when (<= token-start line-end)
                ...
                (pcase token
                  ...
                  ('T_DOLLAR_OPEN_CURLY_BRACES (setq end-brace-level (+ end-brace-level 1)))
